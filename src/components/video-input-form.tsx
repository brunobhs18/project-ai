...
export function VideoInputForm(props: VideoInputFormProps){
  ...
  async function convertVideoToAudio(video: File){
    ...
    const ffmep = await getFFmpeg()

    await ffmep.writeFile('input.mp4', await fetchFile(video))

    // ffmep.on('log', log => console.log(log))

    ffmep.on('progress', progress => {
    ...
    const data = await ffmep.readFile('output.mp3')
